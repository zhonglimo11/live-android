...
public class DialogListStyle extends Style {
    ...
    private int mapTextStyle(int customTextStyle) {
    ...
    protected int getDialogTitleTextStyle() {
        return mapTextStyle(dialogTitleTextStyle);
    }
    ...
    protected int getDialogUnreadTitleTextStyle() {
        return mapTextStyle(dialogUnreadTitleTextStyle);
    }
    ...
    protected int getDialogMessageTextStyle() {
        return mapTextStyle(dialogMessageTextStyle);
    }
    ...
    protected int getDialogUnreadMessageTextStyle() {
        return mapTextStyle(dialogUnreadMessageTextStyle);
    }
    ...
    protected int getDialogDateStyle() {
        return mapTextStyle(dialogDateStyle);
    }
    ...
    protected int getDialogUnreadDateStyle() {
        return mapTextStyle(dialogUnreadDateStyle);
    }
    ...
    protected int getDialogUnreadBubbleTextStyle() {
        return mapTextStyle(dialogUnreadBubbleTextStyle);
    }
