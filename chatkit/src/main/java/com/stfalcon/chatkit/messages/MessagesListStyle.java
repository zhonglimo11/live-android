...
/**
 * MessagesListStyle的样式通过xml属性自定义
 */
public class MessagesListStyle extends Style {
    ...
    protected int getIncomingTextStyle() {
        return mapTextStyle(incomingTextStyle);
    }
    ...
    protected int getOutcomingTextStyle() {
        return mapTextStyle(outcomingTextStyle);
    }
    ...
    protected int getOutcomingTimeTextStyle() {
        return mapTextStyle(outcomingTimeTextStyle);
    }
    ...
    protected int getOutcomingImageTimeTextStyle() {
        return mapTextStyle(outcomingImageTimeTextStyle);
    }
    ...
    protected int getDateHeaderTextStyle() {
        return mapTextStyle(dateHeaderTextStyle);
    }
    ...
    protected int getIncomingTimeTextStyle() {
        return mapTextStyle(incomingTimeTextStyle);
    }
    ...
    protected int getIncomingImageTimeTextStyle() {
        return mapTextStyle(incomingImageTimeTextStyle);
    }
